...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wakjsc = __webpack_require__(192);
	
	var _wakjsc2 = _interopRequireDefault(_wakjsc);
	
	var _browserHttpClient = __webpack_require__(214);
	
	var _browserHttpClient2 = _interopRequireDefault(_browserHttpClient);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	_wakjsc2.default.HttpClient = _browserHttpClient2.default;
	
	var wakjsc = new _wakjsc2.default();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _catalogBusiness = __webpack_require__(193);
	
	var _catalogBusiness2 = _interopRequireDefault(_catalogBusiness);
	
	var _directoryBusiness = __webpack_require__(212);
	
	var _directoryBusiness2 = _interopRequireDefault(_directoryBusiness);
	
	var _entity = __webpack_require__(203);
	
	var _entity2 = _interopRequireDefault(_entity);
	
	var _collection = __webpack_require__(210);
	...
	var WakJSC = (function () {
	  function WakJSC(host) {
	    _classCallCheck(this, WakJSC);
	
	    this._httpClient = new WakJSC.HttpClient({
	      apiPrefix: (host || '') + '/rest'
	    });
	
	    var directoryBusiness = new _directoryBusiness2.default({
	      wakJSC: this
	    });
	
	    this.directory = {
	      login: function login(username, password, duration) {
	      ...
	      currentUserBelongsTo: function currentUserBelongsTo(group) {
	        return directoryBusiness.currentUserBelongsTo(group);
	      }
	    };
	
	    this.helper = {
	      isEntity: function isEntity(object) {
	        return object instanceof _entity2.default;
	      },
	      isCollection: function isCollection(object) {
	  ...
	  _createClass(WakJSC, [{
	    key: 'getCatalog',
	    value: function getCatalog(dataClasses) {
	      var catalogBusiness = new _catalogBusiness2.default({
	        wakJSC: this
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _abstractBusiness = __webpack_require__(194);
	
	var _abstractBusiness2 = _interopRequireDefault(_abstractBusiness);
	
	var _catalogService = __webpack_require__(195);
	
	var _catalogService2 = _interopRequireDefault(_catalogService);
	
	var _catalog = __webpack_require__(197);
	
	var _catalog2 = _interopRequireDefault(_catalog);
	
	var _dataclass = __webpack_require__(198);
	
	var _dataclassBusiness = __webpack_require__(199);
	
	var _dataclassBusiness2 = _interopRequireDefault(_dataclassBusiness);
	...
	var CatalogBusiness = (function (_AbstractBusiness) {
	  _inherits(CatalogBusiness, _AbstractBusiness);
	
	  function CatalogBusiness(obj) {
	    _classCallCheck(this, CatalogBusiness);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CatalogBusiness).call(this, obj));
	
	    _this.service = new _catalogService2.default({
	      wakJSC: _this.wakJSC
	    });
	    return _this;
	  }
	
	  _createClass(CatalogBusiness, [{
	    key: 'get',
	    value: function get(dataClasses) {
	      var _this2 = this;
	      ...
	      return this.service.get(dataClasses).then(function (dataClassDBOArray) {
	        ...
	        try {
	          for (var _iterator = dataClassDBOArray[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            var dcDBO = _step.value;
	            ...
	            try {
	              for (var _iterator2 = dcDBO.attributes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                var attr = _step2.value;
	
	                switch (attr.kind) {
	                  case 'relatedEntity':
	                    attributes.push(new _dataclass.AttributeRelated({
	                      name: attr.name,
	                      type: attr.type,
	                      kind: attr.kind
	                    }));
	                  ...
	                  case 'alias':
	                    ...
	                    attributes.push(new _dataclass.Attribute({
	                      name: attr.name,
	                      type: attr.type,
	                      readOnly: readOnly,
	                      kind: attr.kind
	                  ...
	                  case 'relatedEntities':
	                    attributes.push(new _dataclass.AttributeCollection({
	                      name: attr.name,
	                      type: attr.type,
	                      kind: attr.kind
	                    }));
	            ...
	            try {
	              for (var _iterator3 = dcDBO.methods[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	            ...
	            var dataClass = new _dataclass.DataClass({
	              name: dcDBO.name,
	            ...
	            var dataClassBusiness = new _dataclassBusiness2.default({
	              wakJSC: _this2.wakJSC,
	              dataClass: dataClass,
	              methods: methods
	            });
...
/***/ function(module, exports) {
	...
	var AbstractBusiness = function AbstractBusiness(_ref) {
	  var wakJSC = _ref.wakJSC;
	
	  _classCallCheck(this, AbstractBusiness);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _abstractService = __webpack_require__(196);
	...
	var CatalogService = (function (_AbstractService) {
	  _inherits(CatalogService, _AbstractService);
	
	  function CatalogService() {
	    _classCallCheck(this, CatalogService);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CatalogService).apply(this, arguments));
	  }
	  ...
	  _createClass(CatalogService, [{
	    ...
	    value: function get(dataClasses) {
	      ...
	      return this.httpClient.get({ uri: '/$catalog' + strDataclasses }).then(function (res) {
	        var catalog = [];
	        ...
	        try {
	          for (var _iterator = rawObj.dataClasses[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            var d = _step.value;
	            ...
	            if (d.attributes) {
	              ...
	              try {
	                for (var _iterator2 = d.attributes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                  var attr = _step2.value;
	            ...
	            if (d.methods) {
	              ...
	              try {
	                for (var _iterator3 = d.methods[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                  var m = _step3.value;
...
/***/ function(module, exports) {
	...
	var AbstractService = function AbstractService(_ref) {
	  var wakJSC = _ref.wakJSC;
...
/***/ function(module, exports) {
	...
	var Catalog = function Catalog(_ref) {
	  ...
	  try {
	    for (var _iterator = dataClasses[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      var dc = _step.value;
...
/***/ function(module, exports) {
	...
	var DataClass = function DataClass(_ref) {
	  var name = _ref.name;
	...
	var AttributeRelated = (function (_Attribute) {
	  _inherits(AttributeRelated, _Attribute);
	
	  function AttributeRelated() {
	    _classCallCheck(this, AttributeRelated);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AttributeRelated).apply(this, arguments));
	  }
	
	  return AttributeRelated;
	})(Attribute);
	
	var AttributeCollection = (function (_Attribute2) {
	  _inherits(AttributeCollection, _Attribute2);
	
	  function AttributeCollection(_ref3) {
	    var name = _ref3.name;
	    var type = _ref3.type;
	    ...
	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(AttributeCollection).call(this, { name: name, type: type, readOnly: readOnly, kind: kind }));
	
	    _this2.entityType = type.substring(0, type.length - 10);
	    return _this2;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _entityBusiness = __webpack_require__(200);
	
	var _entityBusiness2 = _interopRequireDefault(_entityBusiness);
	
	var _dataclassService = __webpack_require__(204);
	
	var _dataclassService2 = _interopRequireDefault(_dataclassService);
	
	var _collectionBusiness = __webpack_require__(205);
	
	var _collectionBusiness2 = _interopRequireDefault(_collectionBusiness);
	
	var _mediaBusiness = __webpack_require__(208);
	
	var _mediaBusiness2 = _interopRequireDefault(_mediaBusiness);
	...
	var DataClassBusiness = (function (_AbstractBusiness) {
	  _inherits(DataClassBusiness, _AbstractBusiness);
	
	  function DataClassBusiness(_ref) {
	    var wakJSC = _ref.wakJSC;
	    var dataClass = _ref.dataClass;
	    var methods = _ref.methods;
	
	    _classCallCheck(this, DataClassBusiness);
	
	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(DataClassBusiness).call(this, { wakJSC: wakJSC }));
	
	    _this2.dataClass = dataClass;
	    _this2.methods = methods;
	    _this2.service = new _dataclassService2.default({
	      wakJSC: _this2.wakJSC,
	      dataClass: dataClass
	    });
	
	    _dataClassBusinessMap.set(dataClass.name, _this2);
	    _this2._dataClassBusinessMap = _dataClassBusinessMap;
	    return _this2;
	  }
	
	  _createClass(DataClassBusiness, [{
	    key: '_decorateDataClass',
	    value: function _decorateDataClass() {
	    ...
	    key: '_addUserDefinedMethods',
	    value: function _addUserDefinedMethods() {
	      var _this3 = this;
	      ...
	      try {
	        var _loop = function _loop() {
	          ...
	          _this3.dataClass[method] = function () {
	            var params = Array.from(arguments);
	            return _this.callMethod(method, params);
	          };
	        };
	
	        for (var _iterator = this.methods.dataClass[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          _loop();
	        }
	      } catch (err) {
	        _didIteratorError = true;
	    ...
	    key: 'callMethod',
	    value: function callMethod(methodName, parameters) {
	      return this.service.callMethod(methodName, parameters).then(function (obj) {
	        ...
	        if (obj && obj.__entityModel) {
	          ...
	          if (business) {
	            ...
	            if (typeof obj.__COUNT !== 'undefined' && typeof obj.__ENTITIES !== 'undefined' && typeof obj.__FIRST !== 'undefined' && typeof obj.__SENT !== 'undefined') {
	    ...
	    value: function find(id, options) {
	      ...
	      return this.service.find(id, opt).then(function (entity) {
	        return _this4._presentationEntityFromDbo({
	          dbo: entity
	        });
	      });
	    }
	    ...
	    value: function query(options) {
	      ...
	      if (!opt.pageSize) {
	        opt.pageSize = _const2.default.DEFAULT_PAGE_SIZE;
	      }
	
	      return this.service.query(opt).then(function (collection) {
	        return _this5._presentationCollectionFromDbo({
	          dbo: collection,
	    ...
	    key: 'create',
	    value: function create(pojo) {
	      var entityToAttach = {};
	      for (var prop in pojo) {
	        if (pojo[prop] instanceof _entity2.default) {
	    ...
	    key: '_createEntity',
	    value: function _createEntity(_ref2) {
	      var key = _ref2.key;
	      ...
	      var business = new _entityBusiness2.default({
	        wakJSC: this.wakJSC,
	        dataClass: this.dataClass,
	        entity: entity,
	    ...
	    value: function _createCollection(_ref3) {
	      var uri = _ref3.uri;
	      var deferred = _ref3.deferred;
	      var pageSize = _ref3.pageSize;
	      var initialSelect = _ref3.initialSelect;
	
	      var collection = new _collection2.default({
	        deferred: deferred,
	        dataClass: this.dataClass
	      });
	      var business = new _collectionBusiness2.default({
	        wakJSC: this.wakJSC,
	        dataClass: this.dataClass,
	        dataClassBusiness: this,
	    ...
	    key: '_createMedia',
	    value: function _createMedia(_ref4) {
	      var uri = _ref4.uri;
	      var isImage = _ref4.isImage;
	      var attributeName = _ref4.attributeName;
	      var entity = _ref4.entity;
	
	      var media = new _media2.default({ uri: uri });
	      var business = new _mediaBusiness2.default({
	        wakJSC: this.wakJSC,
	        media: media,
	        dataClassBusiness: this,
	        isImage: isImage,
	    ...
	    key: '_presentationEntityFromDbo',
	    value: function _presentationEntityFromDbo(_ref5) {
	      var dbo = _ref5.dbo;
	      ...
	      if (dbo.__deferred) {
	        ...
	        try {
	          for (var _iterator2 = this.dataClass.attributes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            var attr = _step2.value;
	
	            var dboAttribute = dbo[attr.name];
	
	            if (dboAttribute) {
	              if (attr instanceof _dataclass.AttributeRelated) {
	              ...
	              } else if (attr instanceof _dataclass.AttributeCollection) {
	    ...
	    key: '_presentationCollectionFromDbo',
	    value: function _presentationCollectionFromDbo(_ref6) {
	      var dbo = _ref6.dbo;
	      var pageSize = _ref6.pageSize;
	      var initialSelect = _ref6.initialSelect;
	      ...
	      if (!dbo) {
	        ...
	        try {
	          for (var _iterator3 = dbo.__ENTITIES[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	            var dboEntity = _step3.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _entityService = __webpack_require__(201);
	
	var _entityService2 = _interopRequireDefault(_entityService);
	...
	var EntityBusiness = (function (_AbstractBusiness) {
	  _inherits(EntityBusiness, _AbstractBusiness);
	
	  function EntityBusiness(_ref) {
	    var wakJSC = _ref.wakJSC;
	    var entity = _ref.entity;
	    var dataClass = _ref.dataClass;
	    var dataClassBusiness = _ref.dataClassBusiness;
	
	    _classCallCheck(this, EntityBusiness);
	
	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(EntityBusiness).call(this, { wakJSC: wakJSC }));
	
	    _this2.entity = entity;
	    _this2.dataClass = dataClass;
	    _this2.dataClassBusiness = dataClassBusiness;
	    _this2.service = new _entityService2.default({
	      wakJSC: wakJSC,
	      entity: entity,
	      dataClass: dataClass
	    });
	  ...
	  _createClass(EntityBusiness, [{
	    key: '_decorateEntity',
	    value: function _decorateEntity() {
	    ...
	    value: function _addUserDefinedMethods() {
	      ...
	      try {
	        var _loop = function _loop() {
	          ...
	          //Voluntary don't use fat arrow notation to use arguments object without a bug
	          _this3.entity[method] = function () {
	            var params = Array.from(arguments);
	            return _this.callMethod(method, params);
	          };
	        };
	
	        for (var _iterator = this.dataClassBusiness.methods.entity[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          _loop();
	        }
	      } catch (err) {
	        _didIteratorError = true;
	    ...
	    value: function fetch(options) {
	      ...
	      return this.dataClassBusiness.find(this.entity._key, options).then(function (fresherEntity) {
	        _this4._refreshEntity({ fresherEntity: fresherEntity });
	        return _this4.entity;
	      });
	    }
	  }, {
	    key: 'callMethod',
	    value: function callMethod(methodName, parameters) {
	      ...
	      return this.service.callMethod(methodName, parameters).then(function (obj) {
	        ...
	        if (obj && obj.__entityModel) {
	          var business = _this5.dataClassBusiness._dataClassBusinessMap.get(obj.__entityModel);
	    ...
	    value: function save() {
	      ...
	      try {
	        for (var _iterator2 = this.dataClass.attributes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          ...
	          } else if (!(attr instanceof _dataclass.AttributeCollection) && !attr.readOnly) {
	      ...
	      return this.service.save(data, expand).then(function (entityDbo) {
	        var fresherEntity = _this7.dataClassBusiness._presentationEntityFromDbo({
	          dbo: entityDbo
	        });
	
	        _this7._refreshEntity({ fresherEntity: fresherEntity });
	        return _this7.entity;
	      });
	    }
	  }, {
	    key: '_refreshEntity',
	    value: function _refreshEntity(_ref2) {
	      var fresherEntity = _ref2.fresherEntity;
	    ...
	    key: '_getExpandString',
	    value: function _getExpandString() {
	      var expand = '';
	      var _iteratorNormalCompletion3 = true;
	      var _didIteratorError3 = false;
	      var _iteratorError3 = undefined;
	      ...
	      try {
	        for (var _iterator3 = this.dataClass.attributes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	          var attr = _step3.value;
	
	          if (attr instanceof _dataclass.AttributeRelated || attr instanceof _dataclass.AttributeCollection) {
	            if (this.entity[attr.name] instanceof _entity2.default) {
	              expand += attr.name + ',';
	            }
	          }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EntityService = (function (_AbstractService) {
	  _inherits(EntityService, _AbstractService);
	
	  function EntityService(_ref) {
	    var wakJSC = _ref.wakJSC;
	    var entity = _ref.entity;
	    var dataClass = _ref.dataClass;
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EntityService).call(this, { wakJSC: wakJSC }));
	  ...
	  _createClass(EntityService, [{
	    key: 'save',
	    value: function save(data, expand) {
	      ...
	      return this.httpClient.post({
	        ...
	        _util2.default.removeRestInfoFromEntity(entity);
...
/***/ function(module, exports) {
	...
	var Util = (function () {
	  ...
	  _createClass(Util, null, [{
	    ...
	    key: 'removeRestInfoFromEntity',
	    value: function removeRestInfoFromEntity(entity) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataClassService = (function (_AbstractService) {
	  _inherits(DataClassService, _AbstractService);
	
	  function DataClassService(_ref) {
	    var wakJSC = _ref.wakJSC;
	    var dataClass = _ref.dataClass;
	
	    _classCallCheck(this, DataClassService);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DataClassService).call(this, { wakJSC: wakJSC }));
	
	    _this.dataClass = dataClass;
	    return _this;
	  }
	
	  _createClass(DataClassService, [{
	    key: 'find',
	    value: function find(id, options) {
	      ...
	      var optString = _util2.default.handleOptions(options);
	    ...
	    value: function query(options) {
	      ...
	      return this.httpClient.get({
	        ...
	        try {
	          for (var _iterator = collection.__ENTITIES[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _collectionService = __webpack_require__(206);
	...
	var CollectionBusiness = (function (_AbstractBusiness) {
	  _inherits(CollectionBusiness, _AbstractBusiness);
	
	  function CollectionBusiness(_ref) {
	    var wakJSC = _ref.wakJSC;
	    var dataClass = _ref.dataClass;
	    var collection = _ref.collection;
	    var dataClassBusiness = _ref.dataClassBusiness;
	    var collectionUri = _ref.collectionUri;
	    var pageSize = _ref.pageSize;
	    var initialSelect = _ref.initialSelect;
	
	    _classCallCheck(this, CollectionBusiness);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CollectionBusiness).call(this, { wakJSC: wakJSC }));
	
	    _this.collection = collection;
	    _this.dataClass = dataClass;
	    _this.dataClassBusiness = dataClassBusiness;
	    _this.service = new _collectionService2.default({
	      wakJSC: wakJSC,
	      collection: collection,
	      dataClass: dataClass,
	  ...
	  _createClass(CollectionBusiness, [{
	    key: '_decorateCollection',
	    value: function _decorateCollection() {
	    ...
	    value: function fetch(options) {
	      ...
	      return this.service.fetch(opt).then(function (collectionDbo) {
	        var fresherCollection = _this2.dataClassBusiness._presentationCollectionFromDbo({
	          dbo: collectionDbo
	        });
	
	        _this2._refreshCollection({ fresherCollection: fresherCollection });
	    ...
	    value: function more() {
	      ...
	      return this.service.fetch(options).then(function (dbo) {
	        _this3.collection._sent += dbo.__ENTITIES.length;
	        ...
	        try {
	          for (var _iterator = dbo.__ENTITIES[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            var entity = _step.value;
	
	            _this3.collection.entities.push(_this3.dataClassBusiness._presentationEntityFromDbo({
	              dbo: entity
	            }));
	          }
	        } catch (err) {
	    ...
	    value: function _addUserDefinedMethods() {
	      ...
	      try {
	        for (var _iterator2 = this.dataClassBusiness.methods.collection[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	    ...
	    key: '_refreshCollection',
	    value: function _refreshCollection(_ref2) {
	      var fresherCollection = _ref2.fresherCollection;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CollectionService = (function (_AbstractService) {
	  _inherits(CollectionService, _AbstractService);
	
	  function CollectionService(_ref) {
	    var wakJSC = _ref.wakJSC;
	    var collection = _ref.collection;
	    var dataClass = _ref.dataClass;
	    var collectionUri = _ref.collectionUri;
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CollectionService).call(this, { wakJSC: wakJSC }));
	
	    _this.collection = collection;
	    _this.dataClass = dataClass;
	    _this.collectionUri = collectionUri;
	    _this.isEntitySet = _this._isEntitySetUri({ uri: collectionUri });
	    return _this;
	  }
	  ...
	  _createClass(CollectionService, [{
	    ...
	    value: function fetch(options) {
	      ...
	      return this.httpClient.get({
	        ...
	        if (obj.__ENTITYSET) {
	          _this2.collectionUri = obj.__ENTITYSET;
	          _this2.isEntitySet = _this2._isEntitySetUri({ uri: obj.__ENTITYSET });
	        }
	        ...
	        try {
	          for (var _iterator = obj.__ENTITIES[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            var entity = _step.value;
	    ...
	    key: '_isEntitySetUri',
	    value: function _isEntitySetUri(_ref2) {
	      var uri = _ref2.uri;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mediaService = __webpack_require__(209);
	...
	var MediaBusiness = (function (_AbstractBusiness) {
	  _inherits(MediaBusiness, _AbstractBusiness);
	
	  function MediaBusiness(_ref) {
	    var wakJSC = _ref.wakJSC;
	    ...
	    _classCallCheck(this, MediaBusiness);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MediaBusiness).call(this, { wakJSC: wakJSC }));
	
	    _this.media = media;
	    _this.entity = entity;
	    _this.dataClassBusiness = dataClassBusiness;
	    _this.isImage = isImage === true;
	    _this.service = new _mediaService2.default({
	      wakJSC: wakJSC,
	      mediaBusiness: _this,
	      media: media,
	      attributeName: attributeName,
	  ...
	  _createClass(MediaBusiness, [{
	    key: '_decorateMedia',
	    value: function _decorateMedia() {
	      this.media.upload = this.upload.bind(this);
	      this.media.delete = this.delete.bind(this);
	    }
	  }, {
	    key: 'upload',
	    value: function upload(file, mimeType) {
	      var _this2 = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MediaService = (function (_AbstractService) {
	  _inherits(MediaService, _AbstractService);
	
	  function MediaService(_ref) {
	    var wakJSC = _ref.wakJSC;
	    var mediaBusiness = _ref.mediaBusiness;
	    var media = _ref.media;
	    var attributeName = _ref.attributeName;
	    var dataClassBusiness = _ref.dataClassBusiness;
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MediaService).call(this, { wakJSC: wakJSC }));
	  ...
	  _createClass(MediaService, [{
	    ...
	    value: function _buildUri() {
	      return '/' + this.dataClassName + '(' + this.entity._key + ')' + '/' + this.attributeName;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _directoryService = __webpack_require__(213);
	
	var _directoryService2 = _interopRequireDefault(_directoryService);
	...
	var DirectoryBusiness = (function (_AbstractBusiness) {
	  _inherits(DirectoryBusiness, _AbstractBusiness);
	
	  function DirectoryBusiness(_ref) {
	    var wakJSC = _ref.wakJSC;
	
	    _classCallCheck(this, DirectoryBusiness);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DirectoryBusiness).call(this, { wakJSC: wakJSC }));
	
	    _this.service = new _directoryService2.default({ wakJSC: wakJSC });
	    return _this;
	  }
	
	  _createClass(DirectoryBusiness, [{
	    key: 'login',
	    value: function login(username, password, duration) {
	
	      var durationTime = duration || _const2.default.DEFAULT_SESSION_DURATION;
	
	      if (!(typeof durationTime === 'number') || durationTime <= 0) {
	        throw new Error('Directory.login: invalid duration parameter');
	      }
	
	      return this.service.login(username, password, durationTime).catch(function () {
	    ...
	    value: function logout() {
	      return this.service.logout().catch(function () {
	    ...
	    value: function currentUser() {
	      return this.service.currentUser().then(function (dbo) {
	        return dbo;
	      }).catch(function () {
	    ...
	    key: 'currentUserBelongsTo',
	    value: function currentUserBelongsTo(group) {
	
	      if (!(typeof group === 'string')) {
	        throw new Error('Directory.currentUserBelongsTo: group must be a string');
	      }
	
	      return this.service.currentUserBelongsTo(group).then(function () {
	        return true;
	      }).catch(function () {
	        return false;
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DirectoryService = (function (_AbstractService) {
	  _inherits(DirectoryService, _AbstractService);
	
	  function DirectoryService() {
	    _classCallCheck(this, DirectoryService);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(DirectoryService).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _httpClient = __webpack_require__(215);
	
	var _httpClient2 = _interopRequireDefault(_httpClient);
	
	var _aureliaHttpClient = __webpack_require__(216);
	
	var _httpResponse = __webpack_require__(226);
	...
	var BrowserHttpClient = (function (_HttpClient) {
	  _inherits(BrowserHttpClient, _HttpClient);
	
	  function BrowserHttpClient(_ref) {
	    var apiPrefix = _ref.apiPrefix;
	
	    _classCallCheck(this, BrowserHttpClient);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BrowserHttpClient).call(this, { apiPrefix: apiPrefix }));
	
	    _this.client = new _aureliaHttpClient.HttpClient();
	    return _this;
	  }
	
	  _createClass(BrowserHttpClient, [{
	    key: 'get',
	    value: function get(_ref2) {
	      ...
	      try {
	        var res = _get(Object.getPrototypeOf(BrowserHttpClient.prototype), 'get', this).call(this, { uri: uri, params: params });
	        if (res !== null) {
	    ...
	    key: '_getWithoutInterceptor',
	    value: function _getWithoutInterceptor(_ref3) {
	      var uri = _ref3.uri;
	
	      var request = this.client.createRequest(this.prefix + uri).asGet().send();
	    ...
	    value: function post(_ref4) {
	      ...
	      try {
	        var res = _get(Object.getPrototypeOf(BrowserHttpClient.prototype), 'post', this).call(this, { uri: uri, data: data, binary: binary });
	        if (res !== null) {
	          return Promise.resolve(res);
	        }
	      } catch (e) {
	      ...
	      var request = this.client.createRequest(this.prefix + uri).asPost().withContent(data).send();
	
	      return this._httpResponseAdaptor({ request: request });
	    }
	  }, {
	    key: '_httpResponseAdaptor',
	    value: function _httpResponseAdaptor(_ref5) {
	      var request = _ref5.request;
	
	      return request.then(function (res) {
	        return new _httpResponse2.default({
...
/***/ function(module, exports) {
	...
	var HttpClient = (function () {
	  ...
	  _createClass(HttpClient, [{
	    ...
	    value: function registerRequestInterceptor(type, callback) {
	      var _this = this;
	    ...
	    key: '_interceptorTypeToArray',
	    value: function _interceptorTypeToArray(type) {
	      var _this2 = this;
	      ...
	      if (typeof type === 'string') {
	        ...
	        type.forEach(function (t) {
	          if (!_this2._isValidInterceptorType(t.toLowerCase())) {
	            throw new Error('HttpClient.registerInterceptor: invalid interceptor type');
	          } else {
	    ...
	    key: '_isValidInterceptorType',
	    value: function _isValidInterceptorType(type) {
